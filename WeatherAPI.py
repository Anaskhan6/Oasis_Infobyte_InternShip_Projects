...
# import requests
# from PIL import Image, ImageTk  # For displaying an icon
# def get_weather():
#     city = city_entry.get()
...
#         weather_icon_label = tk.Label(root, image = icon_image)
#         weather_icon_label.grid(row = 2, column = 2)  # Add it to the grid layout
#
#     else:
